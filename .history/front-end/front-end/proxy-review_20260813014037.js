...
const youngPlayer = Object.create(playerProxy);
youngPlayer.firstName = "Jude";

console.log(youngPlayer.introduction); // 我是 Jude
console.log(youngPlayer.__proto__ === playerProxy);
console.log(playerProxy.prototype.__proto__ === Proxy.prototype);