...
greet()
greet.call(person,"kobe",21,198)
greet.apply(person,["kobe",21,198])
...
let obj = {
  ...
  foo:function(){
    var bar = ()=>{
      console.log("bar:",this);//这里的this指向外层函数的this，它指向obj对象
    }
    return bar
  }
}
...
let obj = {
  ...
  foo:()=>{
    var bar = ()=>{
      console.log("bar:",this);//这里的this指向window
    }
    return bar
  }
}
